...
cap = cv.VideoCapture("video_data/pushup/good_pushup/good_pushup_0.mp4")

frame_idx = 0
n_reps = 0

MIN_ANGLE = 60
UPRIGHT_POS_ANGLE = 135
...
with PoseLandmarker.create_from_options(options) as landmarker:
    while True:
        ...
        # get right side points (wrist, elbow, shoulder)
        right_wrist = landmark_array[15]
        right_elbow = landmark_array[13]
        right_shoulder = landmark_array[11]

        # get left side points (wrist, elbow, shoulder)
        left_wrist = landmark_array[16]
        left_elbow = landmark_array[14]
        left_shoulder = landmark_array[12]
